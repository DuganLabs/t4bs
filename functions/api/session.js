...
/* POST /api/session
     { mode: "daily" }            → today's puzzle, server-picked, once per UTC day
   ...
   chosen here from the UTC day, not accepted from the client, and a
   finished result for today is a 409 instead of a fresh round. */
