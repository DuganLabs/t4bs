...
const HELP_CONTENT = `
  ...
  <div data-bn-region="help-body">
    ...
    <p><b>4 &middot; The keyboard talks about the word you&rsquo;re on. </b>Every mark on it is about <em>this</em> word and nothing else: placed in this word (&check;), in this word but not placed yet (&#9670;), ruled out of this word (&#10005;) &mdash; and a ruled-out key goes dead, so you can&rsquo;t spend an attempt on it twice. The letter bank below the grid is the wider view: those letters are somewhere in the phrase, not necessarily here.</p>
